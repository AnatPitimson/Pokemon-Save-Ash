...
public class GameOver extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TextView gamesPlayed_Label=(TextView) findViewById(R.id.games_played);
        gamesPlayed_Label.setText(""+(games+1));
        ...
        score_Lable.setText(""+score);

        SharedPreferences preferencesScore=getSharedPreferences("Details",Context.MODE_PRIVATE);
        SharedPreferences.Editor editor3=preferencesGames.edit();
        editor3.putInt("score",score);
        editor3.commit();
        ...
        okBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!nameEt.getText().toString().isEmpty()) // if entered a name
                {
                    ...
                    Toast.makeText(GameOver.this, enterName, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
